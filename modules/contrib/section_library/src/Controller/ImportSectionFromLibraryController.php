...
class ImportSectionFromLibraryController implements ContainerInjectionInterface {
   ...
   *   A render array.
   */
  public function build($section_library_id, SectionStorageInterface $section_storage, int $delta) {
    ...
    if ($sections) {
      ...
      foreach ($reversed_sections as $section) {
        ...
        \Drupal::moduleHandler()->alter('section_library_import', $deep_cloned_section, $current_section);

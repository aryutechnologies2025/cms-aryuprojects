...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.WeMegaMenu.clickActions = function() {
    $(once('li-we-mega-menu-li-a', 'li.we-mega-menu-li a')).each(function () {
    ...
    $(once('span-close-icon-remove', 'span.close.icon-remove')).each(function() {
    ...
    $(once('div.nav-item', 'nav, li.we-mega-menu-li, div.we-mega-menu-submenu, div.we-mega-menu-row-old, div.we-mega-menu-col')).each(function() {
      $(this).on('click', function(e) {
  ...
  Drupal.WeMegaMenu.defineToolbarEvent = function() {
    ...
    $(once('we-mega-menu-btn-submenu', '.we-mega-menu.we-mega-menu-btn-submenu')).each(function() {
    ...
    $(self.toolbar).each(function() {
      var previous_class = null;
      $(once('we-mega-menu-txt-extra-class', '.we-mega-menu-txt-extra-class', this)).each(function() {
    ...
    $(self.toolbar).each(function() {
      var previous_class = null;
      $(once('cbx-we-mega-menu-col-width', '.cbx-we-mega-menu-col-width', this)).eq(0).each(function() {
        $(this).on('focus', function () {
    ...
    $(self.toolbar).each(function() {
      $(once('we-mega-menu-btn-add-row', '.we-mega-menu-btn-add-row', this)).each(function() {
        $(this).on('click', function() {
          self.menu.find('.selected').removeClass('selected');
          var html = '';
          html += '<div class="we-mega-menu-row" data-element-type="we-mega-menu-row">';
      ...
      $(once('we-mega-menu-btn-add-col', '.we-mega-menu-btn-add-col', this)).each(function() {
        $(this).on('click', function() {
      ...
      $(once('we-mega-menu-btn-remove-col', '.we-mega-menu-btn-remove-col', this)).each(function() {
        $(this).on('click', function() {
          if (self.currentSelected.closest('.we-mega-menu-row').children('.we-mega-menu-col').length <= 12) {
      ...
      $(once('we-mega-menu-txt-icon','.we-mega-menu-txt-icon', this)).each(function() {
        $(this).on('change', function() {
          var icon = $(this).val();
          if (icon.length) {
      ...
      $(once('we-mega-menu-txt-caption', '.we-mega-menu-txt-caption', this)).each(function() {
        $(this).on('change', function() {
      ...
      $(once('we-mega-menu-cbx-target', 'select.we-mega-menu-cbx-target', this)).each(function() {
        $(this).on('change', function() {
          var target = $(this).val();
          if (target.length) {
      ...
      // SUBMENU
      $(once('data-hide-sub-when-collapse', '.hide-sub-when-collapse', this)).each(function() {
        $(this).on('change', function() {
          if (self.currentSelected.hasClass('we-mega-menu-submenu')) {
            if ($(this).is(':checked')) {
      ...
      $(once('we-mega-menu-txt-sub-menu-width', '.we-mega-menu-txt-sub-menu-width', this)).each(function() {
        $(this).on('change', function() {
          var width = $(this).val();
          if (self.currentSelected.hasClass('we-mega-menu-submenu')) {
            if (width.length) {
      ...
      $(once('we-mega-menu-align-btn-group', '.we-mega-menu-align-btn-group button', this)).each(function() {
        $(this).on('click', function() {
      ...
      $(once('we-mega-menu-btn-hide-when-collapse', '.we-mega-menu-btn-hide-when-collapse', this)).each(function() {
        $(this).on('change', function() {
          if (self.currentSelected.hasClass('we-mega-menu-col')) {
            if ($(this).is(':checked')) {
      ...
      $(once('cbx-select-block', '.cbx-select-block', this)).each(function() {
        $(this).on('change', function() {
          var bid = $(this).val();
          $.ajax({
            type: "POST",
      ...
      $(once('btn-show-block-title', '.btn-show-block-title', this)).each(function() {
        $(this).on('change', function() {
          if (self.currentSelected.hasClass('we-mega-menu-col')) {
            if ($(this).is(':checked')) {
      ...
      $(once('we-mega-menu-cbx-style', '.we-mega-menu-cbx-style', this)).each(function() {
        $(this).on('change', function() {
      ...
      $(once('we-mega-menu-cbx-animation', '.we-mega-menu-cbx-animation', this)).each(function() {
        $(this).on('change', function() {
          var menu = $('nav.navbar-we-mega-menu');
      ...
      $(once('we-mega-menu-txt-delay', '.we-mega-menu-txt-delay', this)).each(function() {
        $(this).on('change', function() {
          var menu = $('nav.navbar-we-mega-menu');
      ...
      $(once('we-mega-menu-txt-duration', '.we-mega-menu-txt-duration', this)).each(function() {
        $(this).on('change', function() {
          var menu = $('nav.navbar-we-mega-menu');
      ...
      $(once('we-mega-menu-chx-auto-arrow', '.we-mega-menu-chx-auto-arrow', this)).each(function() {
        $(this).on('change', function() {
          var menu = $('nav.navbar-we-mega-menu');
          if ($(this).is(':checked')) {
      ...
      $(once('we-mega-menu-cbx-action', '.we-mega-menu-cbx-action', this)).each(function() {
        $(this).on('change', function() {
          var menu = $('nav.navbar-we-mega-menu');
      ...
      $(once('we-mega-menu-chx-alway-show-submenu', '.we-mega-menu-chx-alway-show-submenu', this)).each(function() {
        $(this).on('change', function() {
          var menu = $('nav.navbar-we-mega-menu');
          if ($(this).is(':checked')) {
      ...
      $(once('we-mega-menu-chx-group', '.we-mega-menu-chx-group', this)).each(function() {
        $(this).on('change', function() {
          if (self.currentSelected.hasClass('we-mega-menu-li')) {
            if ($(this).is(':checked')) {
      ...
      $(once('we-mega-menu-chx-mobile-collapse', '.we-mega-menu-chx-mobile-collapse', this)).each(function() {
        $(this).on('change', function() {
          var menu = $('nav.navbar-we-mega-menu');
          if ($(this).is(':checked')) {
      ...
      $(once('we-mega-menu-btn-break-col', '.we-mega-menu-btn-break-col', this)).each(function() {
        $(this).on('click', function() {
          if (self.currentSelected.hasClass('we-mega-menu-li')) {
            var type = $(this).val();
            var curCol = self.currentSelected.closest('.we-mega-menu-col');
  ...
  Drupal.WeMegaMenu.saveConfig = function() {
    $(once('we-mega-menu-button-btn-save', 'div.we-mega-menu button.btn-save')).each(function() {
      $(this).on('click', function() {
        ...
        $(items).each(function(k, e) {
          ...
          item_config['data-target'] = typeof $this.attr('data-target') != 'undefined' ? $this.attr('data-target') : '_self';
  ...
  Drupal.WeMegaMenu.resetConfig = function() {
    $(once('button-btn-btn-danger-btn-reset', 'button.btn.btn-danger.btn-reset')).each(function() {
      $(this).on('click', function() {
    ...
    $(once('button-btn-btn-danger-btn-reset-to-default', 'button.btn.btn-danger.btn-reset-to-default')).each(function() {
      $(this).on('click', function() {
  ...
  Drupal.WeMegaMenu.backendStyle = function() {
    $(once('we-mega-menu-backend-toolbar-horizontal', 'body.we-mega-menu-backend .we-mega-menu .ico-toolbar.ico-toolbar-horizontal')).each(function() {
      $(this).on('click', function() {
        var class_data = '';

...
namespace Drupal\we_megamenu_fork\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "we_megamenu_fork_block",
 *   admin_label = @Translation("Drupal 8 Mega Menu"),
 *   category = @Translation("Drupal 8 Mega Menu"),
 *   deriver = "Drupal\we_megamenu_fork\Plugin\Derivative\WeMegaMenuBlock",
 * )
 */
class WeMegaMenuBlock extends BlockBase {
  ...
  public function build() {
    $build = [
      ...
      '#attached' => [
        'library' => [
          'we_megamenu_fork/form.we-mega-menu-frontend',
        ],
      ],
    ];
    return $build;
